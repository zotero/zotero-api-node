...
Client.prototype.request = function (options, data, callback) {
  ...
  // If promisified, it may happen that the callback is added
...
Client.prototype.flush = function (force) {
  ...
  if (!this.state.delayed) {
    ...
    if (delay) {
      ...
      while (this.messages.length) this.messages.pop().send();
    }
  }
...
Client.prototype.get = function (path, options, headers, callback) {
  ...
  // Handle cases where no all arguments are specified. This is not
